...
# 3.1 & 3.2 Parallel Optimization Diagnostic outputs
```
...
zherujiang/minitorch/fast_ops.py (163)
================================================================================


Parallel loop listing for  Function tensor_map.<locals>._map, /Users/zherujiang/myDrive/Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-zherujiang/minitorch/fast_ops.py (163)
-----------------------------------------------------------------------------------------------|loop #ID
    def _map(                                                                                  |
        out: Storage,                                                                          |
        out_shape: Shape,                                                                      |
...
zherujiang/minitorch/fast_ops.py (182) is hoisted out of the parallel loop
...
The memory allocation derived from the instruction at /Users/zherujiang/myDrive/
Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (183) is hoisted out of the parallel loop
labelled #3 (it will be performed before the loop is executed and reused inside
the loop):
...
rujiang/myDrive/Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (222)
================================================================================


Parallel loop listing for  Function tensor_zip.<locals>._zip, /Users/zherujiang/myDrive/Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-zherujiang/minitorch/fast_ops.py (222)
------------------------------------------------------------------------------------------------------|loop #ID
    def _zip(                                                                                         |
        out: Storage,                                                                                 |
        out_shape: Shape,                                                                             |
...
The memory allocation derived from the instruction at /Users/zherujiang/myDrive/
Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (245) is hoisted out of the parallel loop
...
The memory allocation derived from the instruction at /Users/zherujiang/myDrive/
Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (246) is hoisted out of the parallel loop
labelled #8 (it will be performed before the loop is executed and reused inside
the loop):
...
The memory allocation derived from the instruction at /Users/zherujiang/myDrive/
Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (247) is hoisted out of the parallel loop
labelled #8 (it will be performed before the loop is executed and reused inside
the loop):
...
zherujiang/minitorch/fast_ops.py (286)
================================================================================


Parallel loop listing for  Function tensor_reduce.<locals>._reduce, /Users/zherujiang/myDrive/Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-zherujiang/minitorch/fast_ops.py (286)
--------------------------------------------------------------------------------------------------|loop #ID
    def _reduce(                                                                                  |
        out: Storage,                                                                             |
        out_shape: Shape,                                                                         |
...
The memory allocation derived from the instruction at /Users/zherujiang/myDrive/
Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-
zherujiang/minitorch/fast_ops.py (303) is hoisted out of the parallel loop
...
zherujiang/minitorch/fast_ops.py (321)
================================================================================


Parallel loop listing for  Function _tensor_matrix_multiply, /Users/zherujiang/myDrive/Cornell_courses/CS5781_MLE/miniTorch_workspace/mod3-zherujiang/minitorch/fast_ops.py (321)
-------------------------------------------------------------------|loop #ID
...
# 3.4 Matrix Multiplication Speedup Test
## Runtime Output
```
Timing summary
Size: 64
